...
export const myOrders = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/order/getMyOrders");
...
export const updateOrder = (id, order) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/order/updateOrder/${id}`, order, config);
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/order/updateOrder/${id}`);
